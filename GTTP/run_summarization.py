...
tf.app.flags.DEFINE_integer('max_que_steps', config['max_que_steps'], 'max timesteps of query encoder (max source query tokens)')
	...
	with sess_context_manager as sess:
		...
		while True: # repeats until interrupted
			...
			if train_step % 100 == 0: # flush the summary writer every so often
				...
				print("Loss: ", loss)
				print("Coverage loss: ", coverage_loss)
